...
.btn-group .btn {
    background-color: #0492C2 ; /* Bright blue background for better visibility */
    color: white; /* White text for contrast */
    border-color: white; /* Darker border for definition */
    border-width: 5px;
}

.btn-group .btn:hover {
    background-color: #0A1172; /* Darker shade on hover */
    color: #fff;
}
